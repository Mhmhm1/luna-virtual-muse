...
const DoctorsView: React.FC<DoctorsViewProps> = ({ disease }) => {
  return (
    <div className="mt-2">
      <Card className="p-3 border-emerald-100">
        <h4 className="font-medium text-sm text-emerald-800 mb-1">
          {disease.specialist.title} Specialists
        </h4>
        <p className="text-xs text-gray-600 mb-3">{disease.specialist.description}</p>
